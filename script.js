 ...
 // Display products on the page
    function displayProducts(products) {
        ...
        products.forEach((product, index) => {
            const productHTML = `
                <div class="food-con" data-index="${index}" data-name="${product.name}" data-price="${product.price}">
                    <div class="img-cart">
            ...
            if (cartItems[index]) {
                ...
                // Maintain the "bordered class after page reload"
                document.querySelector(`[data-index="${index}"] .img-cart img`).classList.add('bordered')
            }
        });
    }

// Show the increment/decrement buttons when "Add to Cart" is clicked
...
// Increase the quantity and keep "Add to Cart" hidden
...
// Decrease the quantity and show "Add to Cart" if the quantity is zero
...
function updateCart() {
    ...
    // check if cartItems is empty to add empty illustration
